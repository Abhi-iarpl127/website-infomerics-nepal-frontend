...
import { CardWithImageData } from "@/types/common";
import NumberSlider from "./NumberSlider";
import Link from "next/link";
import Image from "next/image";

const CardsWithImage = ({ data }: { data: CardWithImageData }) => {
  return (
    <div className="section-ptb sec-group">
      <div className="ir-container">
        <div className="row">
          <div className="col-md-4 col-thumb">
            <div className="sec-grp-img">
              {/* <img src="/images/informatics-ratings.jpg" alt=""/> */}
              {data?.Image && (
              <Image
                src={data?.Image?.url
                }
