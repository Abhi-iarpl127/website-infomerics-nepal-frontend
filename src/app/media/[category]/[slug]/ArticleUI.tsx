...
const ArticleUI = ({ slug }: ArticleUIProps) => {
  ...
  return (
    <div className="ir-wrapper">
      {/* {JSON.stringify(articleData?.ListingImage)} */}
      {/* <!-- Home --> */}
      ...
      <div className="ir-breadcrumb">
        <div className="ir-container">
          <nav>
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item">
                <Link href={`/media/${articleData?.category.slug}`}>{articleData?.category.name}</Link>
              </li>
        ...
        {/* <picture>
          <source media="(max-width:640px)" srcSet={articleData?.InnerPageBannerMobile?.url} />
