...
const RegulatoryDisclosersListingDescriptionUI = ({
  PageTitle,
  Subtitle,
  Banner,
  MobileBanner,
  ...
  return (
    <div className="ir-wrapper">
      ...
      <div className="section-ptb regulatory-disclosers">
        <div className="ir-container">
          {innerData.Description && <div dangerouslySetInnerHTML={{__html: innerData.Description}}/>}
          {innerData.blocks && 
          <ListingData
...
export default RegulatoryDisclosersListingDescriptionUI;
