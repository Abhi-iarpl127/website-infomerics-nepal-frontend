...
// Show Global Search
document.getElementById('btnGlobalSearch').addEventListener('click', function () {
    fadeIn(document.getElementById('globalSearch'));
    document.body.style.overflow = 'hidden';
    document.getElementById('bbfSearch').style.display = 'none';
    document.getElementById('searchClose').style.display = 'block';
});
// Hide Global Search
document.getElementById('btnGlobalSearchClose').addEventListener('click', function () {
    fadeOut(document.getElementById('globalSearch'));
    document.body.style.overflow = 'auto';
    document.getElementById('bbfSearch').style.display = 'block';
